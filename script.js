...
//clickable pre-evolution
document.getElementById("evolutions").addEventListener("click", function(event){
    clear();
    let input = document.getElementById("preId").innerText;
    //get new info
    fetcher(input);
});
    ...
    fetch(api_url+input)
        ...
        .then(function(pokemon) {
            ...
            fetch(pokemon.species.url)
                ...
                document.getElementById("infoText").innerText = flavorArray[rand];
                    ...
                    if (species.evolves_from_species != null){
                        ...
                        fetch(api_url + species.evolves_from_species.name)
                            ...
                            .then(function (previous) {
                                document.getElementById("preId").innerText = previous.id;
                                document.getElementById("preName").innerText = previous.name.toUpperCase();
